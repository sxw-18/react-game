  ...
  return (
    <div className="flex gap-6">
      ...
      <div className="flex-1">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-gray-900 to-stone-900 rounded-xl p-6 mb-6 text-white relative overflow-hidden shadow-lg border border-orange-500/10">
           {/* Decorative Elements */}
           ...
           <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
              <div className="flex-1">
                  <h1 className="text-2xl font-bold mb-2 tracking-tight">重温经典 - 免费在线畅玩复古游戏</h1>
                  <p className="text-stone-400 text-sm mb-0 max-w-lg leading-relaxed">体验经典游戏的怀旧魅力，在浏览器中直接畅玩不同年代的经典游戏。无需下载，即点即玩。</p>
              </div>
        ...
        <div className="flex items-center justify-between mb-6">
             ...
             <a href="#" className="text-orange-600 hover:text-orange-800 text-sm font-medium flex items-center gap-1">
                查看所有复古游戏 →
             </a>
        </div>
